...
#include "main.h"
float kp,ki,kd;
extern uint16_t speed_send1,speed_send2,speed_send3,speed_send4;
/***********************上位机调参使用***********************/
...
#ifdef DEBUG
      /* 电机输出 */
      case 0: data[i]=speed_send1;
          break;
      case 1: data[i]=speed_send2;
          break;
      case 2: data[i]=speed_send3;
          break;
      case 3: data[i]=speed_send4;
          break;
#endif
      default:break;
    }
...
void PARAMETER_MODIFICATION(uint8_t * PARAMETER)
{
  switch(PARAMETER[0])
  {
    ...
    case 0x00: kp =PARAMETER_Change_float(PARAMETER+1);
          break;
    case 0x01: ki =PARAMETER_Change_float(PARAMETER+1);
          break;
    case 0x02: kd =PARAMETER_Change_float(PARAMETER+1);
          break;
//    case 0x03: debug_Ki =PARAMETER_Change_float(PARAMETER+1);
//          break;
//    case 0x04: debug_Kd =PARAMETER_Change_float(PARAMETER+1);
//          break;
    /* 以上部分用于机器人控制器参数整定 */
    default:break;
  }
